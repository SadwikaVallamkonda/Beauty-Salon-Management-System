...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/22.jpeg);" data-stellar-background-ratio="0.5">
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/25.jpg);">
						</div>
					</div>
    		</div>
    	</div>
